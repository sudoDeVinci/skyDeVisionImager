...
print("Starting topography processing with AMD GPU acceleration...")
start_time = time.time()

# Use GPU acceleration (will automatically detect AMD GPU and use best method)
figure = graph_plotly(
    tfwfile=TFWFILE,
    tifffile=TIFFFILE,
    points=250,             # Mesh resolution
